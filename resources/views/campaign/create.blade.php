...
<div class="w-full">
    ...
    <div class="bg-green-500 text-white py-10 text-center">
        <h1 class="text-3xl font-extrabold">Tambah Campaign</h1>
        <p class="text-green-100 mt-1 text-sm">Buat campaign donasi baru</p>
    </div>
    ...
    <div class="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <div class="bg-white rounded-2xl shadow-md overflow-hidden">
            ...
            <div class="bg-green-50 border-b border-green-200 px-6 py-4 flex items-center gap-3">
                <div class="w-10 h-10 bg-green-500 rounded-full flex items-center justify-center text-white text-lg">➕</div>
                <h2 class="text-lg font-bold text-gray-800">Form Tambah Campaign</h2>
            </div>
            ...
            <form action="{{ route('campaign.store') }}" method="POST" class="px-6 py-6 space-y-5">
                ...
                <div>
                    ...
                    <input type="text" id="title" name="title"
                        value="{{ old('title') }}"
                        placeholder="Contoh: Bantu Korban Banjir Pontianak"
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="4"
                        placeholder="Ceritakan tujuan dan detail campaign ini..."
